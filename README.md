...
**Frontend**
- React, TypeScript, Next.js, Vue.js, Vite, Blazor
- Tailwind CSS,Bootstrap, Shadcn/Radix/Material UI
- Eslint, Prettier

**Backend**
- Node.js, Express / Fastify, ASP.NET Core
- REST APIs & basic GraphQL
- Authentication & authorization, OAuth,JWT

**Database & DevOps**
- PostgreSQL,Supabase, SQL Server, MongoDB
- Prisma / Drizzle
